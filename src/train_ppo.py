...
class PPOAgent:
    ...
    def __init__(
        ...
        """
        self.actor_uncompiled = Actor(obs_dim, action_dim).to(device)
        self.critic_uncompiled = Critic(obs_dim).to(device)
    ...
    def save(self):
        torch.save(self.actor_uncompiled.state_dict(), "models/ppo.actor.pt")
        torch.save(self.critic_uncompiled.state_dict(), "models/ppo.critic.pt")
